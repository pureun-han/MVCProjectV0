...
<div id="main">
    <div class="row">
        <div class="col-md-12 text-center">
            ...
            <img src="../img/arong/arong1.jpg" class="margin30" style="width: 400px; height: 400px; margin: 15px;">
            <p>아롱아 밥먹어라 아롱아 밥먹어라 아롱아 밥먹어라 아롱아 밥먹어라
                아롱아 밥먹어라 아롱아 밥먹어라 아롱아 밥먹어라 아롱아 밥먹어라
                아롱아 밥먹어라 아롱아 밥먹어라 아롱아 밥먹어라 아롱아 밥먹어라
                아롱아 밥먹어라 아롱아 밥먹어라 아롱아 밥먹어라 아롱아 밥먹어라</p>
    ...
    <div class="row margin30">
        ...
        <div class="col-md-4">
            <h2>SNS</h2>
            <p><img src="../img/ico_in.png"> arong_chuu<br>
                <img src="../img/ico_in.png"> Ar0rnt2_2</p>
            <p><button type="button" class="btn btn-light">자세히보기 &blacktriangleright;</button></p>
        </div>
    </div>
</div>
