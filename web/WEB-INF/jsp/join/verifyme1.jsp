...
<!--메인영역 시작-->
    ...
    <div id="main">
        ...
        <!--중요한 내용!-->
        <div class="alert alert-danger mgnpdg15" role="alert">
            <ul style="margin-bottom: -3px;">
                <li class="list-inline" style="margin-left: -25px;"><span class="badge badge-danger">중요한 내용!</span></li>
                ...
                <div class="row">
                    ...
                    <div class="col-5 ">
                        <div class="form-group row margin20">
                            <label for="ph1" class="col-4 col-form-label">휴대폰 번호</label>
                            <select id="ph1" class="col-3 form-control">
                                <option>국번</option><option>010</option>
                                <option>011</option><option>019</option>
                            </select>
                            <label class="form-check-label">&nbsp;&ndash;&nbsp;</label>
                            <input type="text" id="ph2" class="form-control col-2">
                            <label class="form-check-label">&nbsp;&ndash;&nbsp;</label>
                            <input type="text" id="ph3" class="form-control col-2">
                        </div>
                    </div>
                    <div class="col-5">
                        <ul>
                            <li>메세지 수신 가능한 휴대폰으로 인증번호를 받을 수 있습니다.</li>
                            <li>휴대폰번호 입력 후 '인증번호 요청하기' 버튼을 눌러주세요.</li>
                ...
                <div class="row">
                    ...
                    <div class="col-5">
                        <ul>
                            ...
                            <li>통신사 문의 전 스팸문자함, 메시지함 요량 초과 여부, 차단설정을 확인해 주십시오. </li>
                        </ul>
                    </div>
                    <div class="col"></div>
                </div>
