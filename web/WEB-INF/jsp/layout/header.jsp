...
<nav class="nav navbar-expand-md navbar-light bg-light">
    <div class="collapse navbar-collapse">
        <ul class="nav navbar-nav nav-fill w-100">
            ...
            <li class="nav-item">
                <a class="nav-link" href="/join/agree1.do">회원가입</a></li>
            <li class="nav-item">
                <a class="nav-link" href="/board/list1.do">게시판</a></li>
            <li class="nav-item">
                <a class="nav-link" href="/pds/list1.do">자료실</a></li>
            <li class="nav-item">
                <a class="nav-link" href="/gallery/list1.do">갤러리</a></li>
            <li class="nav-item">
